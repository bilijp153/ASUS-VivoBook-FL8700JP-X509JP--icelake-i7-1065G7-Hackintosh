...
6. 完成安装后 ➔ 迁移 EFI 至本机固态EFI分区

### 3. SMBIOS 配置

推荐机型：MacBookAir9,1
工具：使用 **OpenCore Configurator**或者[**OCAuxiliaryTools**](https://github.com/ic005k/OCAuxiliaryTools)
注意：必须生成**唯一三码**且验证验证序列号状态显示 **"无效"**！
...
<details>
  ...
  Ice Lake 处理器已移除 HDMI 控制器支持。
</details>

<details>
  <summary><b>Q: 触控板偶发失灵？</b></summary>
  ELAN1200 驱动限制，暂时通过重启恢复。
</details>
