...
- Go to `Apple Serial Number Lookup Website` via the tool's Verify Serial Number button and enter the verification code (the serial number is automatically entered).
